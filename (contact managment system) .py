...
def DisplayForm():
    ...
    display_screen.title("Made by Zeel Shah ")
    global tree
    global SEARCH
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="CONTACTS", font=('verdana', 18), width=600,bg="blue" ,  fg="white")
    ...
    lbl_txtsearch = Label(LeftViewForm, text="Enter Name", font=('verdana', 10),bg="#15244C", fg="white")
    lbl_txtsearch.pack()
